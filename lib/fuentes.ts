...
export const FUENTES: Fuente[] = [
  {
    ...
    conexion: "API de Marketing · una llave que se genera en el negocio",
    dificultad: "10 minutos, la llave la sacas tú",
    campos: [
      { campo: "Gasto por día", estado: "medido" },
      { campo: "Impresiones y alcance por día", estado: "medido" },
      { campo: "Clics por día", estado: "medido" },
      { campo: "Conversaciones iniciadas por día", estado: "medido" },
      { campo: "Costo por conversación", estado: "medido" },
      { campo: "Edad y género de quien responde", estado: "medido" },
      { campo: "Región y ciudad", estado: "medido" },
